-- ⚔️ HSTNLX REPAIR: SCHEMA SYNCHRONIZATION (V13.5)
-- mapping: user_id -> buyer_id (Orders Table)
...
-- 2. DEPLOY DEFINITIVE HARDENED ENGINE (V13.5)
...
BEGIN
  ...
  LOOP
    ...
    -- 🛡️ SCHEMA SYNC: using buyer_id instead of user_id
    ...
    VALUES ('order_created', 'unified_engine_v13.5', 'success', v_user_id, v_order_id::text, jsonb_build_object('payment_id', p_payment_id, 'amount', v_order_total));
