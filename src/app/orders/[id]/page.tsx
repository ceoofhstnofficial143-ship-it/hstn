                            ...
                            {[
                                ...
                                return (
                                    <div key={step.id} className="relative z-10 flex gap-8 items-start group">
                                        <div className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center border-2 bg-white transition-all duration-700 ${isCurrent ? 'border-primary ring-4 ring-primary/10 shadow-lg scale-110' :
